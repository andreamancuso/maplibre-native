...
add_executable(mbgl-wasm 
    ${PROJECT_SOURCE_DIR}/platform/emscripten/src/mbgl/emscripten/main.cpp
    ${INCLUDE_FILES}
    ${SRC_FILES}
    ${EXTRA_SRC_FILES}
)
...
target_link_libraries(mbgl-wasm
    PRIVATE 
        Mapbox::Base::Extras::kdbush.hpp
        Mapbox::Base::supercluster.hpp
        Mapbox::Base::shelf-pack-cpp
...
set_target_properties(mbgl-wasm PROPERTIES COMPILE_FLAGS "-O0 -pthread --use-port=libjpeg --use-port=sqlite3 --use-port=zlib --use-port=libpng")
set_target_properties(mbgl-wasm PROPERTIES LINK_FLAGS "-O0 -pthread --use-port=libjpeg --use-port=zlib --use-port=sqlite3 --use-port=libpng -s USE_GLFW=3 -s USE_WEBGPU=1 -s FULL_ES3=1 -sPTHREAD_POOL_SIZE_STRICT=0")
